...
public class SearchPageObject extends MainPageObject {
    ...
    public void initSearchInput() {
        this.waitForElementPresent(By.xpath(SEARCH_INIT_ELEMENT), "Cannot find search input after clicking search element", 5);
    ...
    public void typeSearchLine(String searchLine) {
        this.waitForElementAndSendKeys(By.xpath(SEARCH_INPUT), "Cannot find and type into search input", 5, searchLine);
    }
